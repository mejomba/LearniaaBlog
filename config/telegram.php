...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'            => 'learniaabot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '1451995777:AAHQsFmo7HvPz6fk_3sNOJFDAl08XdnkxNQ'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://bottelegram1.iran.liara.run'),
            'commands'            => [
