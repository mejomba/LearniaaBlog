...
@section('Head')
<title> نمایش برگه ها | لرنیا </title>
  <meta  name="description" content=" نمایش برگه ها | لرنیا">
@endsection
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <h1 class="card-title text-center">جدول برگه ها</h1>
                  <p class="card-category text-center">
                    
                  <a href="{{route('admin.pages.create')}}" class="btn btn-primary btn-round" 
                  style="font-size:1.0rem;"> ایجاد برگه
                  </a>                
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    عملیات
                      ...
                      <a class="btn" style="color:#00bcd4" href="{{ route('admin.pages.edit',$page['pk_page']) }}"> 
                      <img src="{{ asset('images/Template/edit.svg') }}" alt="Thumbnail Image" height="30px" width="30px">
                        ...
                        <button style="color:#e91e63" type="button" class="btn"
                         onclick="Modal_Delete( {{$page['pk_page'] }})" data-toggle="modal" data-target="#exampleModal">
...
{ 
  ...
  location.replace( baseUrl + "admin/pages/delete/"+ id);
}
</script>
<!---- Modal Delete -->                            
