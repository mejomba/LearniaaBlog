...
@section('Head')
<title> ایجاد درخت  | لرنیا  </title>
  <meta  name="description" content=" ایجاد درخت| لرنیا">
@endsection
...
<div class="container-fluid">
   ...
   <form method="POST" action="{{route('admin.tree.store')}}" enctype="multipart/form-data" style="min-height:270px;">
        @csrf
