...
<title> نمایش کاربر | لرنیا </title>
  <meta  name="description" content=" نمایش کاربر | لرنیا">
@endsection
                    ...
                    عملیات
                      ...
                      <img src="{{ asset('images/Template/edit.svg') }}" alt="Thumbnail Image" height="30px" width="30px">
                        ...
                        <button style="color:#e91e63" type="button" class="btn"
                         onclick="Modal_Delete( {{ $user['pk_users'] }} )" data-toggle="modal" data-target="#exampleModal">
...
{ 
  ...
  location.replace( baseUrl + "admin/user/delete/"+ id);
}
</script>
<!---- Modal Delete -->                            
