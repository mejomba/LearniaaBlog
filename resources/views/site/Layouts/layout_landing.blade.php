...
<style>.custom_shadow{box-shadow : 0 16px 24px 2px rgba(0, 0, 0, 0.0), 0 6px 30px 5px rgba(0, 0, 0, 0), 0 8px 10px -5px rgba(0, 0, 0, 0.2) ;}</style>
</head>
...
<script>
    !function (t, e, n) {
        ...
        s.id = "ua-script-yn-33531-adv"; s.dataset.analyticsobject = n;
