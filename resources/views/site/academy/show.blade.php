...
<!-- Test -->
<div class="col-lg-5 col-md-6 col-sm-11 col-12 mx-auto" style="margin-top:80px !important">
                    <div class="card border-none mt-4" style="border-radius: 20px;box-shadow: 0px 0px 20px black;border-style: none">
                        ...
                        <div class="row">
                                ...
                                <h3 style="color:#FFFFFF" class="text-center">{{$current_course['name']}}</h3>
                                </button>
                                </div>
                                <div class="col-md-12 col-12 col-lg-12 col-sm-12 text-center ">
                                    <div class="row">
                                  ...
                                  <a style="padding-bottom : 5px" _target="blank"
                                   href="{{ route('api.downloadcount',$current_course['pk_course'])}}"
                                    ...
                                    class="btn btnGreen btn-round">خرید دوره {{$package['fa_name']}} </a>                           
                                  @endif
