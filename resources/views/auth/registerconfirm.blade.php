...
<h3 class="p-2" style="background-color:#20C5BA"> کد تایید به شماره تلفن و یا ایمیل وارد شده ارسال شد</h3>
</div>
</div>
<form class="form px-1 py-5" method="POST" action="{{route('register')}}">
@csrf
